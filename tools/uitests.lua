...
eq("tabs in order", table.concat(titles, ","), "Farm,Stack,Farm Other,Fruit & Raid,Teleport,Shop,Player,PVP,ESP,Server,Webhook,Settings")
...
do
    ...
    eq("other tabs still built", table.concat(names, ","), "Broken,Farm,Stack,Farm Other,Fruit & Raid,Teleport,Shop,Player,PVP,ESP,Server,Webhook,Settings")
